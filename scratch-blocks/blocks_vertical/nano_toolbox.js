...
goog.provide('Blockly.Blocks.nanoToolbox');

goog.require('Blockly.Blocks');

Blockly.Blocks.nanoToolbox =
  '<xml id="toolbox-categories" style="display: none">' +
  '<category name="Nano" id="nano" colour="#FF6680" secondaryColour="#FF4D6A" showStatusButton="true">' +
  '<block type="nano_main_" id="nano_main_"></block>' +
  '<block type="nano_digitalWrite_" id="nano_digitalWrite_">' +
  '<value name="NUM">' +
  ...
  '</value>' +
  '</block>' +
  '<block type="nano_digitalRead_" id="nano_digitalRead_"></block>' +
  '</category>' +
  //
  ...
  '</block>' +
  '<sep gap="36"/>' +
  '<block type="more_operator_to_string" id="more_operator_to_string">' +
  '<value name="m01">' +
  '<shadow type="math_number">' +

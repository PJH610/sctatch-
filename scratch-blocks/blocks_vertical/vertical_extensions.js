 ...
 * 生成的函数将设置主色、副色和第三色
 * 基于类别名称。
 * @param {String} category The name of the category to set colours for./要设置颜色的类别的名称。
 * @return {function} An extension function that sets colours based on the given/一种基于给定的颜色设置的扩展函数
 *     category.
 */

...
Blockly.Blocks["uno_rgb"] = {
  init: function () {
    this.jsonInit({
      id: "uno_rgb",
      message0:
        "rgb模块 设置 端口 %1 第 %2 盏 亮度为(0~255) R值 %3 G值 %4 B值 %5",
      args0: [
        {
          type: "field_dropdown",
          name: "port",
...
Blockly.Blocks["uno_rgb_strip"] = {
  init: function () {
    this.jsonInit({
      id: "uno_rgb_strip",
      message0:
        "rgb灯带 灯数 %1 设置 端口 %2 亮度为(0~255) R值 %3 G值 %4 B值 %5",
      args0: [
        {
          type: "input_value",
          name: "number",
...
Blockly.Blocks["uno_rgb_strip_pixel"] = {
  init: function () {
    this.jsonInit({
      ...
      message0:
        "rgb灯带 灯数 %1 设置 端口 %2 第 %3 盏 亮度为(0~255) R值 %4 G值 %5 B值 %6",
      args0: [
        {
          type: "input_value",
          name: "number",
...
Blockly.Blocks["uno_servomotor"] = {
  init: function () {
    this.jsonInit({
      id: "uno_servomotor",
      message0:
        "舵机模块 设置 端口 %1 拓展口 %2 角度为(5~175) %3 延时(毫秒) %4",
      args0: [
        {
          type: "field_dropdown",
          name: "port",

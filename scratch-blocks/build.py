...
class Gen_compressed(threading.Thread):
  ...
  def do_compile_local(self, params, target_filename):
      ...
      args = []
      for group in [["java", "-jar", os.path.join(CLOSURE_ROOT_NPM, CLOSURE_COMPILER_NPM, "compiler.jar")], dash_args]:
...
if __name__ == "__main__":
  try:
    ...
    test_args = ["java", "-jar", os.path.join(CLOSURE_ROOT_NPM, CLOSURE_COMPILER_NPM, "compiler.jar"), os.path.join("build", "test_input.js")]

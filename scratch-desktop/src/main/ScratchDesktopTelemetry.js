...
class ScratchDesktopTelemetry {
    ...
    projectDidLoad(metadata = {}) {
        this._telemetryClient.addEvent('project::load', {
            ...EVENT_TEMPLATE,
            ...metadata
        })
    }
    ...
    projectDidSave(metadata = {}) {
        this._telemetryClient.addEvent('project::save', {
            ...EVENT_TEMPLATE,
            ...metadata
        })
    }
    ...
    projectWasCreated(metadata = {}) {
        this._telemetryClient.addEvent('project::create', {
            ...EVENT_TEMPLATE,
            ...metadata
        })
    }
    ...
    projectWasUploaded(metadata = {}) {
        this._telemetryClient.addEvent('project::upload', {
            ...EVENT_TEMPLATE,
            ...metadata
        })
    }

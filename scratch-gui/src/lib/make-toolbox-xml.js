...
const uno3 = function () {
    return `
    <category name="通信" id="uno3" colour="#58a0f2" secondaryColour="#3373CC">
...
const makeToolboxXML = function (
    ...
    const everything = [
        ...
        gap,
        uno1(isStage, targetId),
        gap,
        uno2(isStage, targetId),
        gap,
        uno3(isStage, targetId),
    ];
